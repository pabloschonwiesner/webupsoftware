	...
	<?php 
		...
		if(isset($articulos) && $articulos) {
			...
			foreach ($articulos as $articulo) {
				...
				echo 	'<a  class="articleBlog" href="' . BASE_URL . $articulo['id'] . '">';
				echo 		'<article>';
				echo 			'<figure>';
				echo 				'<img src="' . BASE_LOCAL_IMAGES_WEB . $articulo['id'] . '/principal/' . $articulo['fotoPrincipal'] . '" alt="' . $articulo['fotoPrincipal'] . '" />';
				echo 			'</figure>';
	 ...
	 ?>
	 <footer class="footer">
		<a id="admin" href="<?php echo BASE_URL; ?>admin/p/1">Admin</a>
	</footer>
